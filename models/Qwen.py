...
class Qwen(BaseModel):
    ...
    def __init__(self, api_key=None) -> None:
        self.tokenizer = AutoTokenizer.from_pretrained("Qwen/Qwen2.5-14B-Instruct-1M", device_map="auto")
        self.model = AutoModelForCausalLM.from_pretrained("Qwen/Qwen2.5-14B-Instruct-1M", device_map="auto")
