...
class PurpCodeSFT(BaseModel):

    def __init__(self, api_key=None) -> None:
        self.tokenizer = AutoTokenizer.from_pretrained("purpcode/purpcode-14b-rule-sft", device_map="auto")
        self.model = AutoModelForCausalLM.from_pretrained("purpcode/purpcode-14b-rule-sft", device_map="auto")
