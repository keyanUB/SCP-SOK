...
class MistralSafeCoder(BaseModel):

    def __init__(self, api_key=None) -> None:
        self.tokenizer = AutoTokenizer.from_pretrained("../SafeCoder/mistral-7b-lora-safecoder/checkpoint-last", device_map="auto")
        self.model = AutoModelForCausalLM.from_pretrained("../SafeCoder/mistral-7b-lora-safecoder/checkpoint-last", device_map="auto")
