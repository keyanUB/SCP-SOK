...
class Phi2(BaseModel):
    ...
    def __init__(self, api_key=None) -> None:
        self.tokenizer = AutoTokenizer.from_pretrained("microsoft/phi-2", device_map="auto")
        self.model = AutoModelForCausalLM.from_pretrained("microsoft/phi-2", device_map="auto")
